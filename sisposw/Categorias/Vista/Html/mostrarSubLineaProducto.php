        ...
        <div class="main"> 
            ...
            <main>
                    ...
                    <form action="index.php?accion=ingresarSubLineaProducto" method="post" onsubmit="return validar1();">
                        ...
                        <table border="0" cellspacing="0" cellspadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="campo" type="text" id="SlproDes" name="SlproDes" required autocomplete="off">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../Categorias/" class="botones mostrar_color">Volver</a>
                                </td>
                ...
                <div class="targes">
                    <table>
                        <tr>
                            <td><h3>Sub-Linea de Productos: &nbsp; &nbsp;</h3></td>
