        ...
        <div class="main"> 
            ...
            <main>
                ...
                <div class="targes">
                    ...
                    <form action="index.php?accion=editarSubLineaProducto1" method="POST">
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    <?php while ($fila = $result->fetch_object()) {
                                        ...
                                        <tr>
                                            <td>
                                                <select name="SLproId">
                                                    <option value="<?php echo $fila->SLproId; ?>"><?php echo $fila->SLproId; ?></option>
                                                </select>
                                                
                                               
                                            </td>
                                            <td>
                                                    <input type="text" name="SlproDes" value="<?php echo $fila->SlproDes; ?>" required>
                                            
                                                
                                            </td>
                                            <td>
                                                <select name="LprID">
                                                    <option value="<?php echo $fila->LprID; ?>">
